...
#define PREHEAT_BEFORE_LEVELING //ORIGINAL: //#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 190 //ORIGINAL:   #define LEVELING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time
  #define LEVELING_BED_TEMP 55 //ORIGINAL:   #define LEVELING_BED_TEMP     50
#endif
